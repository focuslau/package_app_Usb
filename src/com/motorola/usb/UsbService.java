...
public class UsbService extends Service
{
    ...
    public static final int USB_MODE_MSC_ADB = 8;
            ...
            public void run() {
                if (enable) {
                    mNotification.contentView.
                        setTextViewText(R.id.usb_mass_storage_switcher,getString(R.string.mass_off));
                    mNotification.contentView.
                        setImageViewResource(R.id.stat_mass, R.drawable.high_temp_point);
                    mStorageManager.enableUsbMassStorage();
                } else {
                    mNotification.contentView.
                        setTextViewText(R.id.usb_mass_storage_switcher,getString(R.string.mass_on));
                    mNotification.contentView.
...
*/
            mNotification.contentView.setTextViewText(R.id.title,getString(R.string.usb_selection_notification_title));
            mNotification.contentView.setTextViewText(R.id.text2,getString(messageRes));
            mNotification.contentIntent = mModeSelectionIntent;

            ComponentName rec = new ComponentName(getPackageName(), MassStorageSwitchReceiver.class.getName());
            Intent endCallButtonIntent = new Intent(ACTION_MASS_STORAGE_SWICTH_BUTTON);
            endCallButtonIntent.setComponent(rec);
            PendingIntent endCallPendingIntent = PendingIntent.getBroadcast(this,
                1, endCallButtonIntent, PendingIntent.FLAG_UPDATE_CURRENT);
            mNotification.contentView.setOnClickPendingIntent(R.id.owner_button, endCallPendingIntent);
